...
export const Menu = () => {
  ...
  return (
    <nav className='smallscreen-nav' style={isMenu ? {display: "flex"} : {display: "none"}}>
        ...
        <p onClick={() => menuFunction("my-portfolio/portfolio")} className={location.pathname === "/my-portfolio/portfolio" || location.pathname === "/my-portfolio/portfolio/project" ? 'active' : ''}>Portfolio</p>
